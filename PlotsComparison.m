...
if time_reverse
    estimated_vals = exp(1i*parameters(1)) * flip(conj(Laser.generate(guess,true).calculate(time - parameters(2))));
    estimated_vals_9th = exp(1i*parameters(1)) * flip(conj(Laser.generate(guess,true).calculate(time - parameters(2))));
    estimated_vals_11th = exp(1i*parameters(1)) * flip(conj(Laser.generate(guess,true).calculate(time - parameters(2))));
