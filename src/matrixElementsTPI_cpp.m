function A = matrixElementsTPI_cpp(initial_energy, ...
...
for end_state = 1:N_states_final
    ...
    if (final_energy < 3 * max(omega_one,omega_two) + initial_energy)
        ...
        term_one = clib.multiphoton.TwoPhotonAmplitude(initial_energy, ...
            cast(N_states_middle,'int32'),real(dipole_middle),middle_energies, ...
            real(dipole_final(:,end_state)),final_energy, ...
        ...
        term_two = subMatrixElementsTPI(initial_energy, ...
            N_states_middle,dipole_middle,middle_energies, ...
            dipole_final(:,end_state),final_energy, ...
            laser_parameters_one,laser_parameters_two, ...
